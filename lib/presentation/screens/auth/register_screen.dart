...
class _RegisterPageState extends State<RegisterPage> {
  ...
  // NUEVO: guarda el código de país seleccionado
  String _countryCode = '+52';

  static const List<String> _termsAndConditions = [
    'Chipi+ es una aplicación de visualización de trailers sobre películas para uso personal y no comercial.',
  ...
  Future<void> _submit() async {
    ...
    try {
      final user = await _registerUseCase(
        ...
        lastName: capitalizeWords(_lastNameController.text),
        email: _emailController.text.trim(),
        password: _passwordController.text,
        // NUEVO: guarda teléfono completo con código de país
        telephone: '$_countryCode${_phoneController.text.trim()}',
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // NUEVO: selector de país + código + número
                        IntlPhoneField(
                          ...
                          validator: (phone) {
                            final local = phone?.number.trim() ?? '';
                            if (local.isEmpty) return 'El teléfono es requerido.';
                            ...
                            Expanded(
                              child: Wrap(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: _isLoading ? null : _showTermsAndConditionsDialog,
                                    child: const Text(
                                      'Términos y condiciones',
